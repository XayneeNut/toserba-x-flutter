...
class OrderSummaryWidget extends StatelessWidget {
  const OrderSummaryWidget({super.key, required this.userAccountModel});
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(
                        userAccountModel.pembelianModel![index].barangEntity!
                            .adminAccountEntity!.username!,
                              ...
                              children: [
                                Expanded(
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        numberFormat.format(userAccountModel
